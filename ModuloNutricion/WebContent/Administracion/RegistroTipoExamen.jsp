...
<nav class="col-sm-2">
        ...
        <h3 class="panel-title">Tipo de Examenes</h3>
        </div>
...
colModel : [
	...
	{display: 'ID', name : 'idTIPO_EXAMEN', width : 50, sortable : true, align: 'center'},
	{display: 'nombre', name : 'nombre', width : 250, sortable : true, align: 'left'}
	],
searchitems : [
	{display: 'ID', name : 'idTIPO_EXAMEN', isdefault: true},
