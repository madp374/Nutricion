...
<nav class="col-sm-2">
        ...
        <h3 class="panel-title">Enfermedad</h3>
        </div>
...
colModel : [
	...
	{display: 'ID', name : 'idENFERMEDAD', width : 50, sortable : true, align: 'center'},
	{display: 'nombre', name : 'nombre', width : 250, sortable : true, align: 'left'}
	],
searchitems : [
	{display: 'ID', name : 'idENFERMEDAD', isdefault: true},
