		...
		<div class="modal fade" id="AlertaModal" role="dialog">
							    <div class="modal-dialog modal-sm">
							      <div class="modal-content">
							        ...
							        <div class="modal-body">
							        <table>
							        	<tr><td rowspan="2"><img src="../images/alerta.jpg" width="50" height="50" /></td><td>&nbsp;<b>Error:</b></td></tr>
							        	<tr><td>&nbsp;<div id="Errortxt1"></div></td></tr>
							        </table>
...
<nav class="col-sm-2">
			...
			<table class="table table-bordered" width="90%" style="font-size:8pt;">  
				<thead>
					...
					<tr >
						...
						<th align="center">RefAM</th>
						<th align="center">Alm</th>
						<th align="center">RefPM</th>
						<th align="center">Cen</th>
					</tr>
				...
				<tbody>
					<tr>
						<td>
							<div class="form-group">
										<label>&nbsp;</label><label>Lacteos sin grasa</label>
						...
						<td align="center">
									<div class="form-group">
								  		<label>Kcal</label><input class="form-control input-sm" id="KcalLacteoSG" name="KcalLacteoSG"     style="width: 40px;" readonly  />                  
								  	</div>
						</td>
						<td align="center">
									<div class="form-group">
								  		<label>grs</label><input class="form-control input-sm" id="ProteLacteoSG" name="ProteLacteoSG"    style="width: 40px;" readonly  />                  
								  	</div>
						</td>
						<td align="center">
									<div class="form-group">
										<label>grs</label><input class="form-control input-sm" id="CarboLacteoSG" name="CarboLacteoSG"   style="width: 40px;" readonly  />                  
								  	</div>
						</td>
						<td align="center">
									<div class="form-group">
								  		<label>grs</label><input class="form-control input-sm" id="GrasaLacteoSG" name="GrasaLacteoSG"    style="width: 40px;" readonly  />                  
								  	</div>
						</td>
						<td align="center">
									<div class="form-group">
										<label>&nbsp;</label>
								  		<input class="form-control input-sm" id="de1" name="de1"  type="number"  style="width: 50px;" min="0" onkeydown="desplazarse('de1','ra1',event)"  />                  
								  	</div>
						</td>
						<td align="center">
									<div class="form-group">
									<label>&nbsp;</label>
								  		<input class="form-control input-sm" id="ra1" name="ra1"  type="number"  style="width: 50px;" min="0" onkeydown="desplazarse('ra1','az1',event)"  />                  
								  	</div>
						</td>
						<td align="center">
									<div class="form-group">
									<label>&nbsp;</label>
								  		<input class="form-control input-sm" id="az1" name="az1"  type="number"  style="width: 50px;" min="0" onkeydown="desplazarse('az1','rp1',event)" />                  
								  	</div>
						</td>
						<td align="center">
									<div class="form-group">
									<label>&nbsp;</label>
								  		<input class="form-control input-sm" id="rp1" name="rp1"  type="number"  style="width: 50px;" min="0" onkeydown="desplazarse('rp1','ce1',event)"  />                  
								  	</div>
						</td>
						<td align="center">
									<div class="form-group">
									<label>&nbsp;</label>
								  		<input class="form-control input-sm" id="ce1" name="ce1"  type="number"  style="width: 50px;" min="0" onkeydown="desplazarse('ce1','de2',event)" />                  
								  	</div>
						</td>
					</tr>
					<tr>
						<td>
							<div class="form-group">
										<label>&nbsp;</label><label>Lacteos enteros</label>
						...
						<td align="center">
									<div class="form-group">
								  		<label>Kcal</label><input class="form-control input-sm" id="KcalLacteoE" name="KcalLacteoE"   style="width: 40px;" readonly  />                  
								  	</div>
						</td>
						<td align="center">
									<div class="form-group">
								  		<label>grs</label><input class="form-control input-sm" id="ProteLacteoE" name="ProteLacteoE"   style="width: 40px;" readonly  />                  
								  	</div>
						</td>
						<td align="center">
									<div class="form-group">
								  		<label>grs</label><input class="form-control input-sm" id="CarboLacteoE" name="CarboLacteoE"    style="width: 40px;" readonly  />                  
								  	</div>
						</td>
						<td align="center">
									<div class="form-group">
								  		<label>grs</label><input class="form-control input-sm" id="GrasaLacteoE" name="GrasaLacteoE"   style="width: 40px;" readonly  />                  
								  	</div>
						</td>
						<td align="center">
									<div class="form-group">
									<label>&nbsp;</label>
								  		<input class="form-control input-sm" id="de2" name="de2"  type="number"  style="width: 50px;" min="0" onkeydown="desplazarse('de2','ra2',event)"  />                  
								  	</div>
						</td>
						<td align="center">
									<div class="form-group">
									<label>&nbsp;</label>
								  		<input class="form-control input-sm" id="ra2" name="ra2"  type="number"  style="width: 50px;" min="0" onkeydown="desplazarse('ra2','az2',event)"  />                  
								  	</div>
						</td>
						<td align="center">
									<div class="form-group">
									<label>&nbsp;</label>
								  		<input class="form-control input-sm" id="az2" name="az2"  type="number"  style="width: 50px;" min="0" onkeydown="desplazarse('az2','rp2',event)"   />                  
								  	</div>
						</td>
						<td align="center">
									<div class="form-group">
									<label>&nbsp;</label>
								  		<input class="form-control input-sm" id="rp2" name="rp2"  type="number"  style="width: 50px;" min="0" onkeydown="desplazarse('rp2','ce2',event)"  />                  
								  	</div>
						</td>
						<td align="center">
									<div class="form-group">
									<label>&nbsp;</label>
								  		<input class="form-control input-sm" id="ce2" name="ce2"  type="number"  style="width: 50px;" min="0" onkeydown="desplazarse('ce2','de3',event)"  />                  
								  	</div>
						</td>
					</tr>
					<tr>
						<td>
							<div class="form-group">
										<label>&nbsp;</label><label>Vegetales</label>
						...
						<td align="center">
									<div class="form-group">
								  		<label>Kcal</label><input class="form-control input-sm" id="KcalVege" name="KcalVege"   style="width: 40px;" readonly  />                  
								  	</div>
						</td>
						<td align="center">
									<div class="form-group">
								  		<label>grs</label><input class="form-control input-sm" id="ProteVege" name="ProteVege"    style="width:40px;" readonly  />                  
								  	</div>
						</td>
						<td align="center">
									<div class="form-group">
								  		<label>grs</label><input class="form-control input-sm" id="CarboVege" name="CarboVege"     style="width: 40px;" readonly  />                  
								  	</div>
						</td>
						<td align="center">
									<div class="form-group">
								  		<label>grs</label><input class="form-control input-sm" id="GrasaVege" name="GrasaVege"   style="width: 40px;" readonly  />                  
								  	</div>
						</td>
						<td align="center">
									<div class="form-group">
									<label>&nbsp;</label>
								  		<input class="form-control input-sm" id="de3" name="de3"  type="number"  style="width: 50px;" min="0" onkeydown="desplazarse('de3','ra3',event)"  />                  
								  	</div>
						</td>
						<td align="center">
									<div class="form-group">
									<label>&nbsp;</label>
								  		<input class="form-control input-sm" id="ra3" name="ra3"  type="number"  style="width: 50px;" min="0" onkeydown="desplazarse('ra3','az3',event)"  />                  
								  	</div>
						</td>
						<td align="center">
									<div class="form-group">
									<label>&nbsp;</label>
								  		<input class="form-control input-sm" id="az3" name="az3"  type="number"  style="width: 50px;" min="0" onkeydown="desplazarse('az3','rp3',event)"  />                  
								  	</div>
						</td>
						<td align="center">
									<div class="form-group">
									<label>&nbsp;</label>
								  		<input class="form-control input-sm" id="rp3" name="rp3"  type="number"  style="width: 50px;" min="0"  onkeydown="desplazarse('rp3','ce3',event)" />                  
								  	</div>
						</td>
						<td align="center">
									<div class="form-group">
									<label>&nbsp;</label>
								  		<input class="form-control input-sm" id="ce3" name="ce3"  type="number"  style="width: 50px;" min="0" onkeydown="desplazarse('ce3','de4',event)"  />                  
								  	</div>
						</td>
					</tr>
					<tr>
						<td>
							<div class="form-group">
										<label>&nbsp;</label><label>Frutas</label>
						...
						<td align="center">
									<div class="form-group">
								  		<label>Kcal</label><input class="form-control input-sm" id="KcalFruta" name="KcalFruta"  style="width: 40px;" readonly  />                  
								  	</div>
						</td>
						<td align="center">
									<div class="form-group">
								  		<label>grs</label><input class="form-control input-sm" id="ProteFruta" name="ProteFruta"   style="width:40px;" readonly  />                  
								  	</div>
						</td>
						<td align="center">
									<div class="form-group">
								  		<label>grs</label><input class="form-control input-sm" id="CarboFruta" name="CarboFruta"   style="width: 40px;" readonly  />                  
								  	</div>
						</td>
						<td align="center">
									<div class="form-group">
								  		<label>grs</label><input class="form-control input-sm" id="GrasaFruta" name="GrasaFruta"  style="width: 40px;" readonly  />                  
								  	</div>
						</td>
						<td align="center">
									<div class="form-group">
									<label>&nbsp;</label>
								  		<input class="form-control input-sm" id="de4" name="de4"  type="number"  style="width: 50px;" min="0" onkeydown="desplazarse('de4','ra4',event)"  />                  
								  	</div>
						</td>
						<td align="center">
									<div class="form-group">
									<label>&nbsp;</label>
								  		<input class="form-control input-sm" id="ra4" name="ra4"  type="number"  style="width: 50px;" min="0" onkeydown="desplazarse('ra4','az4',event)"  />                  
								  	</div>
						</td>
						<td align="center">
									<div class="form-group">
									<label>&nbsp;</label>
								  		<input class="form-control input-sm" id="az4" name="az4"  type="number"  style="width: 50px;" min="0" onkeydown="desplazarse('az4','rp4',event)"  />                  
								  	</div>
						</td>
						<td align="center">
									<div class="form-group">
									<label>&nbsp;</label>
								  		<input class="form-control input-sm" id="rp4" name="rp4"  type="number"  style="width: 50px;" min="0" onkeydown="desplazarse('rp4','ce4',event)"  />                  
								  	</div>
						</td>
						<td align="center">
									<div class="form-group">
									<label>&nbsp;</label>
								  		<input class="form-control input-sm" id="ce4" name="ce4"  type="number"  style="width: 50px;" min="0" onkeydown="desplazarse('ce4','de5',event)"  />                  
								  	</div>
						</td>
					</tr>
					<tr>
						<td>
							<div class="form-group">
										<label>&nbsp;</label><label>Cereales</label>
						...
						<td align="center">
									<div class="form-group">
								  		<label>Kcal</label><input class="form-control input-sm" id="KcalCereal" name="KcalCereal"  style="width: 40px;" readonly  />                  
								  	</div>
						</td>
						<td align="center">
									<div class="form-group">
								  		<label>grs</label><input class="form-control input-sm" id="ProteCereal" name="ProteCereal"   style="width: 40px;" readonly  />                  
								  	</div>
						</td>
						<td align="center">
									<div class="form-group">
								  		<label>grs</label><input class="form-control input-sm" id="CarboCereal" name="CarboCereal"   style="width: 40px;" readonly  />                  
								  	</div>
						</td>
						<td align="center">
									<div class="form-group">
								  		<label>grs</label><input class="form-control input-sm" id="GrasaCereal" name="GrasaCereal"   style="width: 40px;" readonly  />                  
								  	</div>
						</td>
						<td align="center">
									<div class="form-group">
									<label>&nbsp;</label>
								  		<input class="form-control input-sm" id="de5" name="de5"  type="number"  style="width: 50px;" min="0" onkeydown="desplazarse('de5','ra5',event)"  />                  
								  	</div>
						</td>
						<td align="center">
									<div class="form-group">
									<label>&nbsp;</label>
								  		<input class="form-control input-sm" id="ra5" name="ra5"  type="number"  style="width: 50px;" min="0" onkeydown="desplazarse('ra5','az5',event)"  />                  
								  	</div>
						</td>
						<td align="center">
									<div class="form-group">
									<label>&nbsp;</label>
								  		<input class="form-control input-sm" id="az5" name="az5"  type="number"  style="width: 50px;" min="0" onkeydown="desplazarse('az5','rp5',event)"  />                  
								  	</div>
						</td>
						<td align="center">
									<div class="form-group">
									<label>&nbsp;</label>
								  		<input class="form-control input-sm" id="rp5" name="rp5"  type="number"  style="width: 50px;" min="0" onkeydown="desplazarse('rp5','ce5',event)"  />                  
								  	</div>
						</td>
						<td align="center">
									<div class="form-group">
									<label>&nbsp;</label>
								  		<input class="form-control input-sm" id="ce5" name="ce5"  type="number"  style="width: 50px;" min="0" onkeydown="desplazarse('ce5','de6',event)"  />                  
								  	</div>
						</td>
					</tr>
					<tr>
						<td>
							<div class="form-group">
										<label>&nbsp;</label><label>Carnes</label>
						...
						<td align="center">
									<div class="form-group">
								  		<label>Kcal</label><input class="form-control input-sm" id="KcalCarne" name="KcalCarne"  style="width: 40px;" readonly  />                  
								  	</div>
						</td>
						<td align="center">
									<div class="form-group">
								  		<label>grs</label><input class="form-control input-sm" id="ProteCarne" name="ProteCarne"   style="width: 40px;" readonly  />                  
								  	</div>
						</td>
						<td align="center">
									<div class="form-group">
								  		<label>grs</label><input class="form-control input-sm" id="CarboCarne" name="CarboCarne"  style="width: 40px;" readonly  />                  
								  	</div>
						</td>
						<td align="center">
									<div class="form-group">
								  		<label>grs</label><input class="form-control input-sm" id="GrasaCarne" name="GrasaCarne"  style="width: 40px;" readonly  />                  
								  	</div>
						</td>
						<td align="center">
									<div class="form-group">
									<label>&nbsp;</label>
								  		<input class="form-control input-sm" id="de6" name="de6"  type="number"  style="width: 50px;" min="0" onkeydown="desplazarse('de6','ra6',event)"   />                  
								  	</div>
						</td>
						<td align="center">
									<div class="form-group">
									<label>&nbsp;</label>
								  		<input class="form-control input-sm" id="ra6" name="ra6"  type="number"  style="width: 50px;"  min="0" onkeydown="desplazarse('ra6','az6',event)"  />                  
								  	</div>
						</td>
						<td align="center">
									<div class="form-group">
									<label>&nbsp;</label>
								  		<input class="form-control input-sm" id="az6" name="az6"  type="number"  style="width: 50px;" min="0" onkeydown="desplazarse('az6','rp6',event)"  />                  
								  	</div>
						</td>
						<td align="center">
									<div class="form-group">
									<label>&nbsp;</label>
								  		<input class="form-control input-sm" id="rp6" name="rp6"  type="number"  style="width: 50px;" min="0" onkeydown="desplazarse('rp6','ce6',event)"  />                  
								  	</div>
						</td>
						<td align="center">
									<div class="form-group">
									<label>&nbsp;</label>
								  		<input class="form-control input-sm" id="ce6" name="ce6"  type="number"  style="width: 50px;" min="0" onkeydown="desplazarse('ce6','de7',event)"  />                  
								  	</div>
						</td>
					</tr>
					<tr>
						<td>
							<div class="form-group">
										<label>&nbsp;</label><label>Grasas</label>
						...
						<td align="center">
									<div class="form-group">
								  		<label>Kcal</label><input class="form-control input-sm" id="KcalGrasa1" name="KcalGrasa1"   style="width: 40px;" readonly  />                  
								  	</div>
						</td>
						<td align="center">
									<div class="form-group">
								  		<label>grs</label><input class="form-control input-sm" id="ProteGrasa1" name="ProteGrasa1"  style="width: 40px;" readonly />                  
								  	</div>
						</td>
						<td align="center">
									<div class="form-group">
								  		<label>grs</label><input class="form-control input-sm" id="CarboGrasa1" name="CarboGrasa1"   style="width: 40px;" readonly  />                  
								  	</div>
						</td>
						<td align="center">
									<div class="form-group">
								  		<label>grs</label><input class="form-control input-sm" id="GrasaGrasa1" name="GrasaGrasa1"  style="width: 40px;" readonly  />                  
								  	</div>
						</td>
						<td align="center">
									<div class="form-group">
									<label>&nbsp;</label>
								  		<input class="form-control input-sm" id="de7" name="de7"  type="number"  style="width: 50px;" min="0" onkeydown="desplazarse('de7','ra7',event)"  />                  
								  	</div>
						</td>
						<td align="center">
									<div class="form-group">
									<label>&nbsp;</label>
								  		<input class="form-control input-sm" id="ra7" name="ra7"  type="number"  style="width: 50px;" min="0" onkeydown="desplazarse('ra7','az7',event)"  />                  
								  	</div>
						</td>
						<td align="center">
									<div class="form-group">
									<label>&nbsp;</label>
								  		<input class="form-control input-sm" id="az7" name="az7"  type="number"  style="width: 50px;"  min="0" onkeydown="desplazarse('az7','rp7',event)"  />                  
								  	</div>
						</td>
						<td align="center">
									<div class="form-group">
									<label>&nbsp;</label>
								  		<input class="form-control input-sm" id="rp7" name="rp7"  type="number"  style="width: 50px;" min="0" onkeydown="desplazarse('rp7','ce7',event)"  />                  
								  	</div>
						</td>
						<td align="center">
									<div class="form-group">
									<label>&nbsp;</label>
								  		<input class="form-control input-sm" id="ce7" name="ce7"  type="number"  style="width: 50px;" min="0" onkeydown="desplazarse('ce7','de8',event)"  />                  
								  	</div>
						</td>
					</tr>
					<tr>
						<td>
							<div class="form-group">
										<label>&nbsp;</label><label>Azucares</label>
						...
						<td align="center">
									<div class="form-group">
								  		<label>Kcal</label><input class="form-control input-sm" id="KcalAzucar" name="KcalAzucar"   style="width: 40px;" readonly  />                  
								  	</div>
						</td>
						<td align="center">
									<div class="form-group">
								  		<label>grs</label><input class="form-control input-sm" id="ProteAzucar" name="ProteAzucar"   style="width: 40px;" readonly  />                  
								  	</div>
						</td>
						<td align="center">
									<div class="form-group">
								  		<label>grs</label><input class="form-control input-sm" id="CarboAzucar" name="CarboAzucar"    style="width: 40px;" readonly  />                  
								  	</div>
						</td>
						<td align="center">
									<div class="form-group">
								  		<label>grs</label><input class="form-control input-sm" id="GrasaAzucar" name="GrasaAzucar"    style="width: 40px;" readonly  />                  
								  	</div>
						</td>
						<td align="center">
									<div class="form-group">
									<label>&nbsp;</label>
								  		<input class="form-control input-sm" id="de8" name="de8"  type="number" min="0" style="width: 50px;" onkeydown="desplazarse('de8','ra8',event)"  />                  
								  	</div>
						</td>
						<td align="center">
									<div class="form-group">
									<label>&nbsp;</label>
								  		<input class="form-control input-sm" id="ra8" name="ra8"  type="number" min="0" style="width: 50px;" onkeydown="desplazarse('ra8','az8',event)"  />                  
								  	</div>
						</td>
						<td align="center">
									<div class="form-group">
									<label>&nbsp;</label>
								  		<input class="form-control input-sm" id="az8" name="az8"  type="number" min="0" style="width: 50px;" onkeydown="desplazarse('az8','rp8',event)"  />                  
								  	</div>
						</td>
						<td align="center">
									<div class="form-group">
									<label>&nbsp;</label>
								  		<input class="form-control input-sm" id="rp8" name="rp8"  type="number" min="0" style="width: 50px;" onkeydown="desplazarse('rp8','ce8',event)"  />                  
								  	</div>
						</td>
						<td align="center">
									<div class="form-group">
					...
					<tr>
						...
						<td align="center">
									<div class="form-group">
								  		<label>Total</label><input class="form-control input-sm" id="TKcal" name="TKcal"  style="width: 50px;" readonly  />                 
								  	</div>
						</td>
						<td align="center">
									<div class="form-group">
								  		<label>Total</label><input class="form-control input-sm" id="TProte" name="TProte"   style="width: 40px;" readonly  />                 
								  	</div>
						</td>
						<td align="center">
									<div class="form-group">
								  		<label>Total</label><input class="form-control input-sm" id="TCarbo" name="TCarbo"    style="width: 40px;" readonly  />                 
								  	</div>
						</td>
						<td align="center">
									<div class="form-group">
								  		<label>Total</label><input class="form-control input-sm" id="TGrasa" name="TGrasa"   style="width: 40px;" readonly  />                
								  	</div>
						</td>
					</tr>
					<tr>
						<td colspan="3">
										<label>&nbsp;</label><label>Porcentaje de adecuacion</label>
          ...
          <div class="row" align="center" id="Guard" >
      		<div class="form-group" >	
							...
							<button class="btn btn-default" id="gu1" onclick="Guardar()" >
						     <img src="../imagenes/guardado.png" width="40" height="30" title="Guardar" /></button>
            ...
            <div class="form-group" >		
							...
							<button class="btn btn-default" onclick="Modificar()" id="BtnMod">
						     <img src="../imagenes/guardado.png" width="40" height="30" title="Modificar" /></button>
							
			</div>
			<div class="form-group" >	
							<label>Eliminar</label>	
							<button class="btn btn-default" onclick="EliminarRegistro()" id="BtnEl" >
						     <img src="../imagenes/eliminar.png" width="40" height="30" title="Eliminar" /></button>	
			</form>
			<form action="ReporteDieta.jsp"   class="form-inline" role="form" target="_black">
				...
				<div class="form-group">
					...
					<input type="image" src="../imagenes/report.png" class="btn btn-sm" value="Generar" alt="Generar informe" title="Generar informe" style="width: 80px; height:45px;" > 									
				</div> 
			</form>
		</div>
 ...
 <script type="text/javascript">
	...
	function CerrarSesion(){
  	...
  	function CargaInicio() {
		...
		if(IDCarnet!=undefined){
			...
			window.location.replace("/ModuloNutricion/Administracion/ConsultaExterna.jsp");
		//	if(idVET!=undefined){
			//	CargarEdicion(idVET);
		...
		$.ajax({
	        ...
	        success: function(data){
	        	if(data.resultado=='OK'){
	        		...
	        		VentanaError("Error al cargar del servidor");
	        	}
  	...
  	function VentanaAlerta(mensaje){
		document.getElementById("Errortxt1").innerHTML = "";
		document.getElementById("Errortxt1").innerHTML = " "+mensaje;
		jQuery('#AlertaModal').modal("show");
	}
				...
				if(total!=0){
					for(j=0;j<total;j++){
						if(dataCE[i].idCONSULTA_EXTERNA==data[j].idCONSULTA_EXTERNA){
							opciones+='<option value='+data[j].idCALCULOS_VET+'>'+data[j].fecha+','+data[j].TIPO+'</option>';
						}
  	...
  	function CambioConsulta(entrada){
		...
		window.location.replace("/ModuloNutricion/Administracion/ConsultaExterna.jsp?idCE="+entrada);
	...
	function Modificar(){
		...
		if((idVET!=undefined)&&(idVET!="")&&(variable2!="0")&&variable1!=0&&variable3!=0){
			...
			if(VerificarPorcion2()==false){
    			VentanaAlerta("La distribucion de porciones no concuerdan");
    		}else{
    			if(distKcal){
    				enviar_datos(cadena);
    			}else{
    				VentanaError("Seleccione una distribucion Kcal valida");
    			}
    			
    		}
		}else{
			VentanaError("Verifique que los campos esten completos");
		}
	...
	function MostrarMensajeServidor(texto){
  	...
  	function Guardar(){
		...
		if((carnet!="0")&&(variable2!="0")&&variable1!=0&&variable3!=0){
			var cadena = ['IDCarnet='+ carnet,'a='+action,'p0='+variable0
					      	,"p1="+variable1,"p2="+variable2,"p3="+variable3,"p4="+variable4,"p5="+variable5
					      	,"p6="+variable6,"p7="+variable7,"p8="+variable8,"p9="+variable9,"p10="+variable10
					      	,"p11="+variable11,"p12="+variable12,"p13="+variable13,"p14="+variable14,"p15="+variable15
					      	,"p16="+variable16,"p17="+variable17,"p18="+variable18,"p19="+variable19,"p20="+variable20
	        ...
	        success: function(data){
	        	if(data.resultado=='OK'){
	        		...
	        		if(data.mensaje=="1"){
	        			...
	        			MostrarMensajeServidor("Informacion eliminada con exito");
  	...
  	document.getElementById('peso').onkeypress = function (e) {
        if (e.which === 13) {
        	...
        	document.getElementById('imc3').value="";
        }
    };
    ...
    function CalculosVET(event){
    	var char = event.which || event.keyCode;
        if(char == 13){ 
        	var auxp=validar_numerovacio("peso");
        	var auxact=validar_numerovacio("ActividadFisica");
        	var auximc3=validar_numerovacio("imc3");
        	if(auxp!="0"&&auxact!="0"&&auximc3!="0"){
        		var PesoKG=0;
            	var FormulaVET="";
            	var VET=0;
            	//var talla=1.6;
        		...
        		VentanaError("Ingrese un valor de peso/IMC/Actividad fisica mayor a cero");
        	}
    ...
    function desplazarse(origen,entrada,e){
    	if (e.which === 13) {
    		document.getElementById(entrada).focus();
    		if(VerificarPorcion()==false){
    			VentanaAlerta("La distribucion de porciones no concuerdan");
    ...
    function VerificarPorcion(){
    	var resultado=true;
    	var variable30=parseInt(validar_numerovacio("de1"));
		var variable31=parseInt(validar_numerovacio("ra1"));
		var variable32=parseInt(validar_numerovacio("az1"));
		var variable33=parseInt(validar_numerovacio("rp1"));
		var variable34=parseInt(validar_numerovacio("ce1"));
		var variable35=parseInt(validar_numerovacio("de2"));
		var variable36=parseInt(validar_numerovacio("ra2"));
		var variable37=parseInt(validar_numerovacio("az2"));
		var variable38=parseInt(validar_numerovacio("rp2"));
		var variable39=parseInt(validar_numerovacio("ce2"));
		
	
		var variable40=parseInt(validar_numerovacio("de3"));
		var variable41=parseInt(validar_numerovacio("ra3"));
		var variable42=parseInt(validar_numerovacio("az3"));
		var variable43=parseInt(validar_numerovacio("rp3"));
		var variable44=parseInt(validar_numerovacio("ce3"));
		var variable45=parseInt(validar_numerovacio("de4"));
		var variable46=parseInt(validar_numerovacio("ra4"));
		var variable47=parseInt(validar_numerovacio("az4"));
		var variable48=parseInt(validar_numerovacio("rp4"));
		var variable49=parseInt(validar_numerovacio("ce4"));
		
		var variable50=parseInt(validar_numerovacio("de5"));
		var variable51=parseInt(validar_numerovacio("ra5"));
		var variable52=parseInt(validar_numerovacio("az5"));
		var variable53=parseInt(validar_numerovacio("rp5"));
		var variable54=parseInt(validar_numerovacio("ce5"));
		var variable55=parseInt(validar_numerovacio("de6"));
		var variable56=parseInt(validar_numerovacio("ra6"));
		var variable57=parseInt(validar_numerovacio("az6"));
		var variable58=parseInt(validar_numerovacio("rp6"));
		var variable59=parseInt(validar_numerovacio("ce6"));
		
		var variable60=parseInt(validar_numerovacio("de7"));
		var variable61=parseInt(validar_numerovacio("ra7"));
		var variable62=parseInt(validar_numerovacio("az7"));
		var variable63=parseInt(validar_numerovacio("rp7"));
		var variable64=parseInt(validar_numerovacio("ce7"));
		var variable65=parseInt(validar_numerovacio("de8"));
		var variable66=parseInt(validar_numerovacio("ra8"));
		var variable67=parseInt(validar_numerovacio("az8"));
		var variable68=parseInt(validar_numerovacio("rp8"));
		var variable69=parseInt(validar_numerovacio("ce8"));
		
		var variable13=parseInt(validar_numerovacio("porLacteoSG"));
		var variable14=parseInt(validar_numerovacio("porLacteoE"));
		var variable15=parseInt(validar_numerovacio("porVege"));
		var variable16=parseInt(validar_numerovacio("porFruta"));
		var variable17=parseInt(validar_numerovacio("porCereal"));
		var variable18=parseInt(validar_numerovacio("porCarne"));
		var variable19=parseInt(validar_numerovacio("porGrasa1"));
		var variable20=parseInt(validar_numerovacio("porAzucar"));
		
		if(variable13<(variable30+variable31+variable32+variable33+variable34)){
			resultado=false;
		}
		if(variable14<(variable35+variable36+variable37+variable38+variable39)){
			resultado=false;
		}
		if(variable15<(variable40+variable41+variable42+variable43+variable44)){
			resultado=false;
		}
		if(variable16<(variable45+variable46+variable47+variable48+variable49)){
			resultado=false;
		}
		if(variable17<(variable50+variable51+variable52+variable53+variable54)){
			resultado=false;
		}
		if(variable18<(variable55+variable56+variable57+variable58+variable59)){
			resultado=false;
		}
		if(variable19<(variable60+variable61+variable62+variable63+variable64)){
			resultado=false;
		}
		if(variable20<(variable65+variable66+variable67+variable68+variable69)){
			resultado=false;
		}
		return resultado;
    }
    function VerificarPorcion2(){
    	var resultado=true;
    	var variable30=parseInt(validar_numerovacio("de1"));
		var variable31=parseInt(validar_numerovacio("ra1"));
		var variable32=parseInt(validar_numerovacio("az1"));
		...
		var sumatorias=variable30+variable31+variable32+variable33+variable34;
		if(variable13!=sumatorias){
			alert("No concuerdan las porciones de lacteos sin grasa");
			resultado=false;
		}
		sumatorias=variable35+variable36+variable37+variable38+variable39;
		if(variable14!=sumatorias){
			alert("No concuerdan las porciones de lacteos enteros");
			resultado=false;
		}
		sumatorias=variable40+variable41+variable42+variable43+variable44;
		if(variable15!=sumatorias){
			alert("No concuerdan las porciones de vegetales");
			resultado=false;
		}
		sumatorias=variable45+variable46+variable47+variable48+variable49;
		if(variable16!=sumatorias){
			alert("No concuerdan las porciones de frutas");
			resultado=false;
		}
		sumatorias=variable50+variable51+variable52+variable53+variable54;
		if(variable17!=sumatorias){
			alert("No concuerdan las porciones de cereales");
			resultado=false;
		}
		sumatorias=variable55+variable56+variable57+variable58+variable59;
		if(variable18!=sumatorias){
			alert("No concuerdan las porciones de carnes");
			resultado=false;
		}
		sumatorias=variable60+variable61+variable62+variable63+variable64;
		if(variable19!=sumatorias){
			alert("No concuerdan las porciones de grasas");
			resultado=false;
		}
		sumatorias=variable65+variable66+variable67+variable68+variable69;
		if(variable20!=sumatorias){
			alert("No concuerdan las porciones de azucares");
			resultado=false;
		}
		return resultado;
    }
