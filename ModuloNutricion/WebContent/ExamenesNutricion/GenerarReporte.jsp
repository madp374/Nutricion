  ...
  <%
 	...
 	ServletOutputStream outputstream = response.getOutputStream();
  	try{
  		...
  		String tiporeporte = request.getParameter("treporte");
  		int diferencia = 0;
  		 ...
  		 if(tiporeporte.equalsIgnoreCase("1")){
  	        ...
  	        String autor="Elaborado por: "+aut;
  			...
  			reportfile = new File (application.getRealPath("EstadisticasCE4.jasper"));
			...
			String valor= "Periodo: "+fecha_ini+" a "+fecha_fin;
  	    	...
  	    	parameter.put("FechaTexto",new String(valor));
  	    	parameter.put("Autor",new String(autor));
  			reportfile = new File (application.getRealPath("EstadisticasMultifasico.jasper"));
  		 }else if(tiporeporte.equalsIgnoreCase("3")){
			String valor= "Periodo: "+fecha_ini+" a "+fecha_fin;
  	    	...
  	    	parameter.put("FechaTexto",new String(valor));
  	    	parameter.put("Autor",new String(autor));
  			reportfile = new File (application.getRealPath("Diagnosticos.jasper"));
  		 }else{
